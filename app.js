...
document.addEventListener('DOMContentLoaded', ()=>{ try{
    renderDashboard(); renderCalendar(); renderDebts(); renderSpending(); initNav(); setupEvents();
  }catch(e){ console.error('[BB] init error', e); alert('Budget Buddy init error. Try refreshing.'); }
